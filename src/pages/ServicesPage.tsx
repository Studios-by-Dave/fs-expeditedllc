...
const ServicesPage = () => (
  <div className="min-h-screen bg-background">
    <SEOHead
      title="Hauling Services — Dump Truck, Gravel, Debris Removal"
      description="Full-service dump truck hauling, gravel & sand delivery, debris removal, aggregate transport, emergency expedited & commercial hauling near Shelby, NC."
      canonical="/services"
    />
    <Navigation />
    <div className="pt-20">
