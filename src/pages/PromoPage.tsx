      ...
      <main className="pt-20 flex items-center justify-center min-h-[calc(100vh-80px)] p-4">
        <div className="bg-[#1a1a1a] max-w-[520px] w-full border border-[rgba(255,255,255,0.2)] relative overflow-hidden animate-fade-up">
          ...
          <div className="p-8 p-[2.5rem] pb-6 border-b border-[rgba(255,255,255,0.2)] relative">
            ...
            <h1 className="font-bebas text-[clamp(64px,18vw,88px)] leading-[0.9] tracking-[0.01em] text-white">
              <span className="text-primary">10%</span><br />
              OFF YOUR<br />
              FIRST HAUL
            </h1>
            
            <p className="text-sm font-light text-[#F5F2EC] mt-3 leading-relaxed">
          ...
          <div className="p-7 p-[2.5rem]">
            ...
            <div className="bg-[#1a1a1a] border border-dashed border-primary p-5 p-[1.25rem_1.5rem] flex items-center justify-between gap-4 mb-7">
              <div>
                <span className="text-xs font-medium tracking-[0.12em] uppercase text-[#F5F2EC] block mb-1">
                  Promo code
                </span>
                <span className="font-bebas text-3xl tracking-[0.05em] text-primary leading-none">
                  1HAUL
                </span>
              </div>
              <button 
                onClick={copyCode}
                className={`px-5 py-2.5 font-sans text-sm font-medium tracking-[0.04em] cursor-pointer transition-all transform active:scale-95 border-none flex-shrink-0 ${
                  copied 
            ...
            <div className="grid grid-cols-3 gap-px bg-[rgba(255,255,255,0.2)] border border-[rgba(255,255,255,0.2)] mb-7">
              <div className="bg-[#1a1a1a] p-4 text-center">
                <div className="font-bebas text-2xl text-primary leading-none mb-1">01</div>
                <p className="text-xs text-[#F5F2EC] leading-relaxed font-normal">Call for a free quote</p>
              </div>
              <div className="bg-[#1a1a1a] p-4 text-center">
                <div className="font-bebas text-2xl text-primary leading-none mb-1">02</div>
                <p className="text-xs text-[#F5F2EC] leading-relaxed font-normal">Mention code at checkout</p>
              </div>
              <div className="bg-[#1a1a1a] p-4 text-center">
                <div className="font-bebas text-2xl text-primary leading-none mb-1">03</div>
                <p className="text-xs text-[#F5F2EC] leading-relaxed font-normal">We haul, you save 10%</p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2.5">
              <a 
                href="tel:8653649011" 
                className="block text-center p-3.5 font-sans text-base font-medium tracking-[0.01em] no-underline transition-opacity transform active:scale-[0.98] bg-white text-black hover:opacity-85"
              >
                📞 Call Joe — (865) 364-9011
              </a>
              <a 
                href="tel:7047518141" 
                className="block text-center p-3.5 font-sans text-base font-medium tracking-[0.01em] no-underline transition-all transform active:scale-[0.98] bg-transparent text-white border border-[rgba(255,255,255,0.3)] hover:border-[rgba(255,255,255,0.5)]"
              >
          ...
          <div className="p-4 p-[1rem_2.5rem] border-t border-[rgba(255,255,255,0.2)] flex items-center justify-between gap-4 flex-wrap">
            <div className="font-bebas text-lg tracking-[0.05em] text-white">
              F&S Expedited LLC
            </div>
            <div className="text-xs text-[#F5F2EC] text-right leading-relaxed">
